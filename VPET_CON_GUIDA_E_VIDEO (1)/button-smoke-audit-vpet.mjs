...
const checks=[
 ...
 ['Mobile direct navigation','VPET_MOBILE_DIRECT_NAV_JS_20260822'],['Breed hub mobile','vpetShowBreedHubMobile'],['Breed list mobile','vpetShowBreedListMobile'],['Breed detail renderer','vpetBreedDetail'],['Cat back navigation','Torna alle razze di gatti'],['Dog back navigation','Torna alle razze di cani'],['Dog detail data','Labrador Retriever'],['Cat detail data','Siamese'],['Search input','type=\\"search\\"|type="search"']
];
const failed=[];
for(const [name,test] of checks){const ok=test instanceof RegExp?test.test(html):html.includes(test);if(!ok)failed.push(name)}
